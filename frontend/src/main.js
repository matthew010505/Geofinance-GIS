  ...
  const cards = [
    {
      ...
      features: [
        " Enhanced access to financial services is pivotal in promoting financial inclusion and unlocking opportunities for socioeconomic advancement.",
      ],
    },
    {
      ...
      features: [
        " By promoting financial inclusion and unlocking opportunities for socioeconomic advancement, these programs empower individuals to access the resources and support they need to thrive in the economy.",
      ],
    },
    {
      ...
      features: [
        "Through their convenience and accessibility, they empower individuals to navigate the financial landscape effectively, driving economic development and prosperity.",
      ],
    },
    {
      ...
      features: [
        ". Empowering individuals with such data enables informed decision-making, ultimately contributing to economic growth and prosperity in marginalized regions.",
      ],
    },

    {
      ...
      features: [
        " By fostering stronger connections and interactions, it unlocks opportunities for individuals to access essential financial services and participate actively in economic growth.",
      ],
    },
    {
      ...
      features: [
        " By streamlining processes and maximizing output, they promote financial inclusion and open doors to socioeconomic advancement",
      ],
    },
  ];
    ...
    <>
      ...
      >
        ...
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center">
          ...
          >
            A digital Financial Platform for rural Indians, particularly
            Farmers, to enhance their digital financial engagement by virtual
            data using Geographic Informative System (GIS). By leveraging making
      ...
      <section id="what-we-do" className="flex flex-row justify-between p-4">
        ...
        <div className="flex-1 text-right text-lg mt-4">
          ...
          >
            ...
            agriculture enthusiasts in cultivating success sustainability.
          </motion.h2>
          <motion.button
            initial={{ opacity: 0, y: 50 }}
            animate={{ opacity: 1, y: 0 }}
      ...
      <div className="w-full h-[500px] bg-black p-20">
        <div className="flex justify-start items-start">
          ...
          >
            In 1998, Grameen Foundation began working in India, and in 2010, it
            established Grameen Foundation India. While continuing to innovate
            in the field of microfinance, Grameen Foundation also developed
            digital technologies to help rural and low-income communities access
            financial services, improve their livelihoods, and safeguard their
            health. The organization is constantly making breakthroughs,
            developing tailored poverty-alleviation solutions that leverage
            digital technology and trusted intermediaries to reach those in the
            "last mile." In 2012, Grameen Foundation for Social Impact (GFSI)
            was established, becoming a leading non-profit organization in
            India. Its mission is to enable the poor, especially women, to
            create a world without poverty and hunger.
          </motion.p>
        </div>
      </div>
        ...
        <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
          <div className="relative max-w-2xl sm:mx-auto sm:max-w-xl md:max-w-2xl sm:text-center">
            ...
            <p className="mb-6 text-base text-indigo-200 md:text-lg">
              Stay informed with the latest updates from Geofinance! Subscribe
              to our newsletter and be the first to know about new features,
            ...
            <footer class="flex flex-col space-y-10 justify-center m-10">
              <nav class="flex justify-center flex-wrap gap-6 text-gray-500 font-medium">
                <a class="hover:text-gray-900" href="https://www.google.com">
                  Home
                </a>
                <a class="hover:text-gray-900" href="https://www.google.com">
                  About
              ...
              <div class="flex justify-center space-x-5">
                <a
                  href="https://www.facebook.com/StopPovertyNow/"
                  target="_blank"
                ...
                <a
                  href="https://www.linkedin.com/company/grameen-foundation-india/"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <img
                ...
                <a
                  href="https://www.instagram.com/grameen_foundation/"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <img
                ...
                <a
                  href="https://twitter.com/GrameenFdn"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <img
              ...
              <p class="text-center text-white font-medium">
                &copy; 2024 Grameen Foundation Ltd. All rights reserved. Grameen
                Foundation is a registered trademark. | Grameen Foundation is a
